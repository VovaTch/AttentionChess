...
blank = os.path.join(CHESS_PATH, 'gui/blank.png')
bishopB = os.path.join(CHESS_PATH, 'gui/bishopb.png')
bishopW = os.path.join(CHESS_PATH, 'gui/bishopw.png')
pawnB = os.path.join(CHESS_PATH, 'gui/pawnb.png')
pawnW = os.path.join(CHESS_PATH, 'gui/pawnw.png')
knightB = os.path.join(CHESS_PATH, 'gui/knightb.png')
knightW = os.path.join(CHESS_PATH, 'gui/knightw.png')
rookB = os.path.join(CHESS_PATH, 'gui/rookb.png')
rookW = os.path.join(CHESS_PATH, 'gui/rookw.png')
queenB = os.path.join(CHESS_PATH, 'gui/queenb.png')
queenW = os.path.join(CHESS_PATH, 'gui/queenw.png')
kingB = os.path.join(CHESS_PATH, 'gui/kingb.png')
kingW = os.path.join(CHESS_PATH, 'gui/kingw.png')
